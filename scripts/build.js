...
const buildAllCom = "babel ./source --out-dir ./build --copy-files --extensions \".js,.jsx,.ts\" --source-maps false";
...
exec(buildAllCom, (buildAllErr, buildAllOut) => {
  ...
  console.log("Generate minified build...");
	...
	const universalComm = isWin ? minifyBuildCom : './node_modules/.bin/' + minifyBuildCom;
